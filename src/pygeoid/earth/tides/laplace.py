...
from pygeoid.conventions.constants import de440, g0, iers2010
...
_body_gm = {
    "moon": de440.GM_moon,
    "sun": de440.GM_sun,
    "mercury": de440.GM_mercury,
    "venus": de440.GM_venus,
    "mars": de440.GM_mars_system,
    "jupiter": de440.GM_jupiter_system,
    "saturn": de440.GM_saturn_system,
    "uranus": de440.GM_uranus_system,
    "neptune": de440.GM_neptune_system,
}
...
class LaplaceTidalEquation:
    ...
    (effect taken with the negative sign), then the corrected value will be
    in the conventional
    ...
    References
    ----------
    - Melchior, P. (1983), The Tides of the Planet Earth.
    ...
    def _get_bodies_gm(self):
        ...
        return [_body_gm[body] for body in self.bodies]
    ...
    def potential_lon_derivative(
        ...
        Returns
        -------
        potential_dlon : ~pygeoid.conventions.units.Quantity
    ...
    def gradient(self, time: Time, lat: u.deg, lon: u.deg, r: u.m) -> u.m / u.s**2:
        ...
        Returns
        -------
        grad : ~pygeoid.conventions.units.Quantity
            Tidal potential radial derivative.
    ...
    def displacement(
        ...
        u_lon : ~pygeoid.conventions.units.Quantity
    ...
    def deformation_potential(
        ...
        """
        potential = self.potential_lat_derivative(time, lat, lon, r)
    ...
    def physical_height_difference(
        ...
        length : ~pygeoid.conventions.units.Quantity
