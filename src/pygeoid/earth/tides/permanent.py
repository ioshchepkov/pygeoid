...
from pygeoid.conventions.constants import g0, iers2010
...
class PermanentTide(_PotentialBase):
    ...
    Attributes
    ----------
    coeff   : ~pygeoid.conventions.units.Quantity, optional
        Coefficient A for M0S0 in given representaion.
    r0   : ~pygeoid.conventions.units.Quantity, optional
    ...
    def potential_lat_derivative(self, position) -> u.m**2 / u.s**2 / u.rad:
        ...
        Returns
        -------
        potential_dlat : ~pygeoid.conventions.units.Quantity
    ...
    def potential_r_derivative(self, position) -> u.m / u.s**2:
        ...
        Returns
        -------
        potential_dr : ~pygeoid.conventions.units.Quantity
    ...
    @u.quantity_input
    def displacement(
        self, position, gravity: u.m / u.s**2 = g0, elastic: bool = True
    ) -> u.m:
        ...
        Returns
        -------
        u_lat : ~pygeoid.conventions.units.Quantity
            Deformation in the north-south direction.
        u_r : ~pygeoid.conventions.units.Quantity
        ...
        u_lat = self.potential_lat_derivative(position) * love["l"] / gravity * u.rad
        u_r = self.potential(position) * love["h"] / gravity
    ...
    def geodetic_height(
        ...
        Returns
        -------
        delta_h : ~pygeoid.conventions.units.Quantity
    ...
    def deformation_potential(self, position) -> u.m**2 / u.s**2:
        ...
        Returns
        -------
        delta_potential : ~pygeoid.conventions.units.Quantity
            Deformation potentia.

        """
        return self.love["k"] * self.potential_lat_derivative(position) * u.rad

    @u.quantity_input
    def gravity(self, position, elastic: bool = True) -> u.m / u.s**2:
        ...
        Returns
        -------
        delta_g : ~pygeoid.conventions.units.Quantity
            Permanent Tidal gravity variation.

        """
        radial_derivative = self.potential_r_derivative(position)
    ...
    @u.quantity_input
    def gravity_ell(self, position, elastic: bool = True) -> u.m / u.s**2:
    ...
    def tilt(
        ...
        Returns
        -------
        tilt : ~pygeoid.conventions.units.Quantity
    ...
    @u.quantity_input
    def geoidal_height(self, position, gravity: u.m / u.s**2 = g0) -> u.m:
        ...
        Returns
        -------
        delta_geoid : ~pygeoid.conventions.units.Quantity
    ...
    def convert_geoidal_height_correction(
        ...
        from_system : {'zero-tide', 'mean-tide', 'non-tidal'}, optional
            ...
            Default value is set to `pygeoid.earth.tides.permanent.DEFAULT_FROM_SYSTEM`.
        to_system : {'zero-tide', 'mean-tide', 'non-tidal'}, optional
            In which tide system is the geoidal height converted.
            Default value is set to `pygeoid.earth.tides.permanent.DEFAULT_TO_SYSTEM`.
        gravity : ~pygeoid.conventions.units.Quantity, optional
            Mean global gravity of the Earth.

        Returns
        -------
        delta_zeta : ~pygeoid.conventions.units.Quantity
    ...
    @u.quantity_input
    def physical_height(self, position, gravity: u.m / u.s**2 = g0) -> u.m:
