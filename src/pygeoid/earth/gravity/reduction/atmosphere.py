...
def ussa76_density(alt_arr: u.km = 0.0 * u.km) -> u.kg / u.m**3:
    ...
    Parameters
    ----------
    alt_arr : ~pygeoid.conventions.units.Quantity
...
def iag_atm_corr_sph(
    ...
    .. math::
        ...
        g_{atm} = \frac{G M(r)}{r^2}

    .. math::

        M(r) = 4\pi \int_r^\infty \rho(r) r^2 dr
    ...
    height_max : ~pygeoid.conventions.units.Quantity
...
def grs80_atm_corr_interp(height: u.m, kind: str = "linear") -> u.mGal:
    ...
    Interpolated from tabulated GRS 80 data.
    ...
    - Moritz, H. (1980). Geodetic reference system 1980.
      Bulletin Geodesique, 54(3), 395-405.
...
def wenzel_atm_corr(height: u.m) -> u.mGal:
    ...
    References
    ----------
    - Wenzel, H., 1985, Hochauflosende Kugelfunktionsmodelle fur des
      Gravitationspotential der Erde: Wissenschaftliche arbeiten der
