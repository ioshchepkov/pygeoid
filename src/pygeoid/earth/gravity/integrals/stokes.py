...
from pygeoid.earth.gravity.integrals.veningmeinesz import VeningMeineszKernel
from pygeoid.fields.integrals import SphericalKernel
...
class StokesKernel(SphericalKernel):
    ...
    def kernel(self, spherical_distance: u.deg):
        ...
        Parameters
        ----------
        spherical_distance : ~pygeoid.conventions.units.Quantity
        ...
        References
        ----------
        - Heiskanen WA, Moritz H (1967) Physical geodesy.
    ...
    def derivative_spherical_distance(self, spherical_distance):
        ...
        on the spherical distance :math:`\psi`:
    ...
    def _kernel_t(self, t):
        ...
        :math:`t = \cos{\psi}`, :math:`-1 \leq t \leq 1`:
    ...
    def _derivative_t(self, t):
        ...
        :math:`t = \cos{\psi}`, :math:`-1 \leq t \leq 1` is:
