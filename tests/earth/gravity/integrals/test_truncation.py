...
from pygeoid.earth.gravity.integrals.truncation import (
    molodensky_truncation_coefficients as Qn,
)
from pygeoid.earth.gravity.integrals.truncation import paul_coefficients
